package com.foriseland.fjf.cache.dao;
...
public interface IMongoBaseDao<T> {
	 ...
	 *  
	 */
	void updateByAnySelective(String[] params, Object[] values,T entity);
	/**
	 * 修改实体
	 * 
	 * @param map
	 ...
	 *  
	 */
	void updateByAnySelective(Map<String,Object> map,T entity);
	 ...
	 *  
	 */
	void updateByAny(String[] params, Object[] values,T entity);
	/**
	 * 修改实体
	 * 
	 *@param map
	 ...
	 *  
	 */
	void updateByAny(Map<String,Object> map,T entity);
	 ...
	 *            属性值
	 */
	void deleteByAny(String propName, Object propValue);
	 ...
	 * @return 结果集合 或 null
	 */
	List<T> findByProps(Map<String,Object> map);
	 ...
	 * @return 结果集合 或 null
	 */
	List<T> findByProps(Map<String,Object> map, String order);
	 ...
	 * @return 唯一结果 或 null
	 */
	T uniqueByProps(Map<String,Object> map);
	 ...
	 * @return 分页模型对象（不会为null）
	 */
	PageModel<T> pageByProps(int pageNo, int pageSize, Map<String,Object> map);
	 ...
	 * @return 分页模型对象（不会为null）
	 */
	PageModel<T> pageByProps(int pageNo, int pageSize, Map<String,Object> map, String order);
